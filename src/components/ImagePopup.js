...
export default function ImagePopup({onClose, card}) {
  return (
          ...
          <div className="popup-image__container">
            <button className="popup-image__close" type="button" aria-label="крестик" onClick={onClose
            }>
              <img src={crosshair} alt="крестик" className="popup__close-button popup-image__close-image" />
            </button>
